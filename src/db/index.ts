...
type TableName = 'users' | 'couriers' | 'sellers' | 'shipments' | 'shipmentEvents' | 'notifications' | 'settlements';
...
class LocalDB {
  ...
  clearAll(): void {
    const tables: TableName[] = ['users', 'couriers', 'sellers', 'shipments', 'shipmentEvents', 'notifications', 'settlements'];
